<?php
    ...
    if ($_FILES['datafile']['error'] == UPLOAD_ERR_OK) {
        $uploadPath = 'D:/Programs/xampp/htdocs/website/tmp/upload/dates.csv';
        move_uploaded_file($_FILES['datafile']['tmp_name'], $uploadPath);

        // Define the output file path
        $resultFile = 'D:/Programs/xampp/htdocs/website/tmp/output/output.csv';

        // Run the python script
        $output = shell_exec("python D:/Programs/xampp/htdocs/website/scripts/time_calc_v5.py 2>&1");
